...
def create_test_parameters():
    """
    Creates and returns default :class:`~frames.attitude_frame.TimeParameters`
    and :class:`~frames.attitude_frame.PlotParameters` objects for testing.

    Returns
    -------
    param_ani : :class:`~frames.attitude_frame.TimeParameters`
        Time parameters for the simulation.
    param_plt : :class:`~frames.attitude_frame.PlotParameters`
        Plotting parameters for the animation.
    """
